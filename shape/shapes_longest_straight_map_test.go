...
func TestAddLongestStraightMap(t *testing.T) {
	ShapesMap := NewShapesLongestStraightMap()
...
func TestMergeLongestStraightMap(t *testing.T) {
	ShapesMap1 := NewShapesLongestStraightMap()
	ShapesMap2 := NewShapesLongestStraightMap()
